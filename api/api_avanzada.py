...
v1 y v2 y añade características de una API del mundo real.
 Información tomada de curso Python ful stack.
¿Qué aporta sobre v2?
...
class Settings:
    ...
    app_name: str = "API Inmobiliaria"
    # Nombre de la aplicación (aparece en /docs y logs).

    version: str = "3.0.0"
    # Versión semántica de la API.

    model_path: str = os.getenv("MODEL_PATH", "models/modelo_inmobiliario.pkl")
    # os.getenv("MODEL_PATH", "models/modelo_inmobiliario.pkl"):
