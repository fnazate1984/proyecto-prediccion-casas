...
df_processed.to_csv('data/processed/plusvalia_procesado.csv', index=False)

# Download the file to the local machine
#files.download('data/processed/plusvalia_procesado.csv')
from pathlib import Path

archivo = Path("data/processed/plusvalia_procesado.csv")

if archivo.exists():
    print(f"Archivo creado: {archivo.resolve()}")
else:
...
#from pathlib import files

# Descargar el archivo .pkl a tu computadora local
model_path = Path('models/modelo_inmobiliario.pkl')
if model_path.exists():
    print(f"Archivo '{model_path}' encontrado.")
else:
